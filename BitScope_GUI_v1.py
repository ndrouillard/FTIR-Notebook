...
from BitScope_stream import close_BitScope, scope_stream
...
#%% Major variables 
scanRate = 1000000 #default sample rate of the BitScope
global Nt, now
Nt = 12288 #maximum number of points from BitScope
myFont = ("Helvetica",12)
...
def plot():
    ...
    (t_vec, y) = scope_stream(scanRate, Nt) #call the scope_stream function from the BitScope_stream code. These parameters are sampling rate and array size
    dt = t_vec[1]-t_vec[0]
